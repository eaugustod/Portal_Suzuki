      ...
      <div className="bg-[#18181b] rounded-3xl max-w-2xl w-full p-6 md:p-8 shadow-2xl border border-[#27272a] animate-in fade-in zoom-in-95 max-h-[92vh] overflow-y-auto">
        {confirmed ? (
          <div className="text-center py-10 space-y-4">
            <div className="w-16 h-16 bg-emerald-950/80 border border-emerald-800/60 text-emerald-400 rounded-full flex items-center justify-center mx-auto shadow-md">
          ...
          <div className="space-y-5">
            ...
            <div className="flex justify-between items-start pb-4 border-b border-[#27272a]">
              <div>
                <span className="text-[10px] font-bold text-[#3b82f6] uppercase tracking-widest block mb-0.5">
                  ...
                  selectedItems.map((item, index) => (
                    <div key={index} className="p-3.5 flex justify-between items-center hover:bg-white dark:bg-neutral-900/60">
                      ...
                      <div className="flex items-center gap-8">
                        ...
                        <span className="w-24 text-right font-bold text-[#60a5fa]">
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              <button 
                ...
                className={`
                  ...
                  ${totalUnits > 0
                    ? 'bg-[#3b82f6] hover:bg-[#2563eb] active:scale-[0.98] text-white shadow-blue-500/20'
