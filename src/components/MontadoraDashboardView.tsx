...
export const MontadoraDashboardView: React.FC<MontadoraDashboardViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-16">
      ...
      <div className="bg-gradient-to-r from-blue-950/90 via-slate-900 to-indigo-950/90 dark:from-blue-950/90 dark:via-[#18181b] dark:to-indigo-950/80 border border-blue-900/30 dark:border-blue-900/50 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden text-white">
        <div className="absolute right-0 top-0 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
        
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-blue-500/20 text-blue-300 dark:text-blue-400 border border-blue-500/30 text-[10px] uppercase font-bold tracking-widest px-3 py-1 rounded-full flex items-center gap-1.5">
                <Factory className="w-3.5 h-3.5" />
                Montadora Oficial • J. Toledo da Amazônia
              </span>
              <span className="bg-emerald-500/20 text-emerald-300 dark:text-emerald-400 border border-emerald-500/30 text-[10px] uppercase font-bold tracking-widest px-3 py-1 rounded-full flex items-center gap-1.5">
            ...
            <p className="text-[13px] text-slate-200 dark:text-neutral-300 max-w-2xl mt-1">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="bg-slate-900/80 dark:bg-neutral-900/80 border border-slate-700/70 dark:border-neutral-800 p-3 rounded-2xl flex items-center gap-3">
            ...
            <button
              ...
              className="bg-slate-900/90 hover:bg-slate-800 dark:bg-neutral-900/90 dark:hover:bg-neutral-800 text-neutral-200 hover:text-white border border-slate-700 dark:border-neutral-700 font-bold px-4 py-3 rounded-2xl text-[12px] flex items-center justify-center gap-2 transition-all shadow-md"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm hover:border-blue-500/40 transition-colors">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] uppercase font-bold text-neutral-500 dark:text-neutral-400 tracking-wider">Faturamento Nacional</span>
            <div className="p-2 bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-xl border border-blue-500/20">
              <DollarSign className="w-4 h-4" />
            </div>
          </div>
          <p className="text-[20px] font-bold text-neutral-900 dark:text-[#fafafa] font-tabular tracking-tight">
            R$ {totalNationalSalesRevenue.toLocaleString('pt-BR')}
          </p>
          <div className="mt-2 space-y-1">
            <div className="flex justify-between text-[11px] text-neutral-500 dark:text-neutral-400 font-tabular">
              <span>Meta: R$ {(totalNationalSalesTarget / 1000000).toFixed(1)}M</span>
              <span className="font-bold text-blue-600 dark:text-blue-400">{totalNationalTargetPercent}%</span>
            </div>
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm hover:border-blue-500/40 transition-colors">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] uppercase font-bold text-neutral-500 dark:text-neutral-400 tracking-wider">Estoque no Pátio (Rede)</span>
            <div className="p-2 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-xl border border-emerald-500/20">
              <Bike className="w-4 h-4" />
            </div>
          </div>
          <p className="text-[20px] font-bold text-neutral-900 dark:text-[#fafafa] font-tabular tracking-tight">
            {totalNationalStockCount} <span className="text-[13px] font-normal text-neutral-500 dark:text-neutral-400">motos</span>
          </p>
          <p className="text-[11px] text-neutral-500 dark:text-neutral-400 mt-2 font-tabular">
            Imobilizado: <strong className="text-neutral-900 dark:text-white">R$ {(totalNationalStockValue / 1000).toLocaleString('pt-BR')}k</strong>
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm hover:border-blue-500/40 transition-colors">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] uppercase font-bold text-neutral-500 dark:text-neutral-400 tracking-wider">Pipeline de Vendas</span>
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm hover:border-blue-500/40 transition-colors">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] uppercase font-bold text-neutral-500 dark:text-neutral-400 tracking-wider">Oficina & Garantias</span>
            <div className="p-2 bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-xl border border-amber-500/20">
              <Wrench className="w-4 h-4" />
            </div>
          </div>
          <p className="text-[20px] font-bold text-neutral-900 dark:text-[#fafafa] font-tabular tracking-tight">
            {totalNationalOS} <span className="text-[13px] font-normal text-neutral-500 dark:text-neutral-400">O.S. ativas</span>
          </p>
          <p className="text-[11px] text-amber-600 dark:text-amber-400 mt-2 font-tabular flex items-center gap-1">
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm hover:border-blue-500/40 transition-colors">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] uppercase font-bold text-neutral-500 dark:text-neutral-400 tracking-wider">Lotes em Transporte</span>
            <div className="p-2 bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-xl border border-indigo-500/20">
              <Truck className="w-4 h-4" />
            </div>
          </div>
          <p className="text-[20px] font-bold text-neutral-900 dark:text-[#fafafa] font-tabular tracking-tight">
            {totalTransitUnits} <span className="text-[13px] font-normal text-neutral-500 dark:text-neutral-400">em trânsito</span>
          </p>
          <p className="text-[11px] text-indigo-600 dark:text-indigo-300 mt-2 font-tabular">
      ...
      <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 md:p-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          ...
          {selectedRegion !== 'todas' && (
            <button
              ...
              className="text-[11px] text-blue-600 dark:text-blue-400 hover:underline font-bold flex items-center gap-1 self-start"
            >
            ...
            return (
              <button
                ...
                className={`p-4 rounded-2xl border text-left transition-all relative overflow-hidden group ${
                  isSelected
                    ? 'bg-blue-50 dark:bg-blue-950/70 border-blue-500 shadow-md ring-1 ring-blue-500'
                    : 'bg-neutral-50 dark:bg-neutral-900/60 border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700'
                }`}
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="font-bold text-[13px] text-neutral-900 dark:text-white">{reg.region}</span>
                  <span className="text-[10px] bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 px-2 py-0.5 rounded-full font-bold">
                    {reg.storeCount} {reg.storeCount === 1 ? 'loja' : 'lojas'}
                  </span>
                </div>

                <p className="text-[15px] font-bold text-neutral-900 dark:text-[#fafafa] font-tabular">
                  R$ {(reg.sales / 1000).toLocaleString('pt-BR')}k
                </p>

                <div className="mt-2 space-y-1">
                  <div className="flex justify-between text-[10px] text-neutral-500 dark:text-neutral-400 font-tabular">
                    <span>Atingimento</span>
                    <span className={`font-bold ${reg.targetPercent >= 100 ? 'text-emerald-600 dark:text-emerald-400' : reg.targetPercent >= 75 ? 'text-blue-600 dark:text-blue-400' : 'text-amber-600 dark:text-amber-400'}`}>
                      {reg.targetPercent}%
                    </span>
                  </div>
                ...
                <div className="mt-2 flex items-center justify-between text-[10px] text-neutral-500 dark:text-neutral-400 pt-2 border-t border-neutral-200 dark:border-neutral-800/80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Top 3 Performers */}
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <Award className="w-4 h-4 text-amber-500 dark:text-amber-400" />
            <h3 className="text-[14px] font-bold text-neutral-900 dark:text-white">Top 3 Concessionárias do Mês</h3>
          </div>
          <div className="space-y-3">
            {topPerformers.map((dealer, idx) => (
              <div 
                key={dealer.profile.id}
                className="p-3 bg-neutral-50 dark:bg-neutral-900/70 border border-neutral-200 dark:border-neutral-800 rounded-2xl flex items-center justify-between hover:border-blue-500/50 transition-colors"
              >
                <div className="flex items-center gap-3">
                  <div className={`w-7 h-7 rounded-xl flex items-center justify-center font-bold text-[12px] ${
                    idx === 0 ? 'bg-amber-400 dark:bg-amber-500 text-black shadow-md shadow-amber-500/20' :
                    idx === 1 ? 'bg-slate-200 dark:bg-slate-300 text-black' :
                    'bg-amber-700 text-white'
                  }`}>
                    {idx + 1}º
                  </div>
                  <div>
                    <p className="font-bold text-[12px] text-neutral-900 dark:text-white">{dealer.profile.name}</p>
                    <span className="text-[10px] text-neutral-500 dark:text-neutral-400">{dealer.profile.city} ({dealer.profile.state})</span>
                  </div>
                </div>
                <div className="text-right font-tabular">
                  <span className="text-[12px] font-bold text-emerald-600 dark:text-emerald-400">{dealer.targetPercent}% da meta</span>
                  <p className="text-[10px] text-neutral-500 dark:text-neutral-400">R$ {(dealer.salesRevenue / 1000).toFixed(0)}k</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-[14px] font-bold text-neutral-900 dark:text-white">Lojas em Atenção da Montadora</h3>
          </div>
          {attentionDealers.length === 0 ? (
            ...
            <div className="space-y-3">
              {attentionDealers.slice(0, 3).map((dealer) => (
                <div 
                  key={dealer.profile.id}
                  className="p-3 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/40 rounded-2xl flex items-center justify-between"
                >
                  <div>
                    <p className="font-bold text-[12px] text-amber-900 dark:text-amber-200">{dealer.profile.name}</p>
                  ...
                  <button
                    ...
                    className="text-[10px] bg-amber-200 hover:bg-amber-300 dark:bg-amber-900/50 dark:hover:bg-amber-800 text-amber-900 dark:text-amber-200 font-bold px-2.5 py-1.5 rounded-lg transition-colors"
                  >
                    Ajustar Risco
                  </button>
                </div>
        ...
        <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[14px] font-bold text-neutral-900 dark:text-white">Carretas de Fábrica em Rota</h3>
            </div>
            <span className="text-[10px] bg-indigo-100 dark:bg-indigo-950 text-indigo-800 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800/40 px-2 py-0.5 rounded-full font-bold">
          ...
          <div className="space-y-2.5">
            {transitOrders.slice(0, 3).map((order) => (
              <div
                ...
                className="p-3 bg-neutral-50 dark:bg-neutral-900/70 border border-neutral-200 dark:border-neutral-800 hover:border-indigo-500/50 rounded-2xl cursor-pointer transition-colors"
              >
                <div className="flex items-center justify-between">
                  <span className="font-bold text-[12px] text-neutral-900 dark:text-white truncate max-w-[180px]">
                    {order.batchName}
                  </span>
                  <span className="text-[10px] bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/40 px-2 py-0.5 rounded font-bold">
                    {order.status}
                  </span>
                </div>
                <div className="flex items-center justify-between text-[10px] text-neutral-500 dark:text-neutral-400 mt-1.5 font-tabular">
                  <span>{order.location}</span>
                  <span className="text-neutral-900 dark:text-white font-bold">{order.unitsCount} unidades</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl p-5 md:p-6 shadow-md space-y-4">
        {/* Controls & Filter Bar */}
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-neutral-200 dark:border-[#27272a]">
          <div>
            <h3 className="text-[16px] font-bold text-neutral-900 dark:text-[#fafafa] flex items-center gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            {/* View Mode Switcher */}
            <div className="flex items-center bg-neutral-100 dark:bg-neutral-900 p-0.5 rounded-xl border border-neutral-200 dark:border-[#27272a]">
              <button
                onClick={() => setViewMode('table')}
                className={`p-1.5 rounded-lg transition-colors ${viewMode === 'table' ? 'bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white shadow-sm' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
              ...
              <button
                ...
                className={`p-1.5 rounded-lg transition-colors ${viewMode === 'cards' ? 'bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white shadow-sm' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
                      ...
                      >
                        ...
                        <td className="py-3.5 px-4 font-medium text-neutral-900 dark:text-white">
                          <div className="flex items-center gap-2.5">
                            <div className="p-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 text-blue-600 dark:text-blue-400 border border-neutral-200 dark:border-neutral-700">
                              <Building2 className="w-4 h-4" />
                            </div>
                            <div>
                              <p className="font-bold leading-tight flex items-center gap-1.5">
                                {d.profile.name}
                                <span className="text-[9px] bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 px-1 py-0.2 rounded font-bold">
                                  {d.profile.state}
                                </span>
                              </p>
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {d.profile.tier && (
                              <span className={`text-[9px] px-1.5 py-0.2 rounded font-bold uppercase ${
                                d.profile.tier === 'Diamante' ? 'bg-cyan-100 dark:bg-cyan-950 text-cyan-800 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-800/50' :
                                d.profile.tier === 'Ouro' ? 'bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800/50' :
                                d.profile.tier === 'Prata' ? 'bg-slate-200 dark:bg-slate-800 text-slate-800 dark:text-slate-300 border border-slate-300 dark:border-slate-700' :
                                'bg-orange-100 dark:bg-orange-950 text-orange-800 dark:text-orange-300 border border-orange-200 dark:border-orange-800/50'
                              }`}>
                                {d.profile.tier}
                              </span>
                            )}
                        ...
                        <td className="py-3.5 px-4 text-right">
                          <p className="font-bold text-neutral-900 dark:text-white">R$ {d.salesRevenue.toLocaleString('pt-BR')}</p>
                        ...
                        <td className="py-3.5 px-4 text-center min-w-[120px]">
                          <div className="flex items-center justify-center gap-2">
                            <span className={`text-[12px] font-bold ${
                              isOverTarget ? 'text-emerald-600 dark:text-emerald-400' : d.targetPercent >= 75 ? 'text-blue-600 dark:text-blue-400' : 'text-amber-600 dark:text-amber-400'
                            }`}>
                              {d.targetPercent}%
                            </span>
                          </div>
                        ...
                        <td className="py-3.5 px-4 text-center">
                          <span className="font-bold text-neutral-900 dark:text-white">{d.stockCount} un.</span>
                          <p className="text-[10px] text-neutral-500">R$ {(d.stockValue / 1000).toFixed(0)}k</p>
                        </td>

                        {/* Factory Quota */}
                        <td className="py-3.5 px-4 text-center">
                          <span className="font-bold text-neutral-800 dark:text-neutral-200">{d.quotaOrdered}/{d.quotaAllocated} un.</span>
                        ...
                        <td className="py-3.5 px-4 text-right">
                          ...
                          <span className={`text-[10px] font-bold ${
                            d.creditUsagePercent > 80 ? 'text-amber-600 dark:text-amber-400' : 'text-neutral-500'
                          }`}>
                        ...
                        <td className="py-3.5 px-4 text-center">
                          <div className="flex items-center justify-center gap-1.5">
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-blue-50 dark:bg-blue-600/20 hover:bg-blue-600 text-blue-600 dark:text-blue-400 hover:text-white border border-blue-200 dark:border-blue-500/30 transition-all"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700 transition-all"
                            >
        ...
        {viewMode === 'cards' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredDealers.map((d) => (
              <div
                key={d.profile.id}
                className="bg-neutral-50 dark:bg-neutral-900/70 border border-neutral-200 dark:border-neutral-800 hover:border-blue-500/50 rounded-2xl p-4 transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border border-neutral-300 dark:border-neutral-700 px-2 py-0.5 rounded-full font-bold">
                        {d.profile.region} • {d.profile.state}
                      </span>
                      {d.profile.tier && (
                        <span className="text-[9px] bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800/40 px-1.5 py-0.5 rounded font-bold">
                          {d.profile.tier}
                        </span>
                      )}
                    </div>
                    <span className={`text-[12px] font-bold ${
                      d.targetPercent >= 100 ? 'text-emerald-600 dark:text-emerald-400' : d.targetPercent >= 75 ? 'text-blue-600 dark:text-blue-400' : 'text-amber-600 dark:text-amber-400'
                    }`}>
                      {d.targetPercent}% da meta
                    </span>
                  </div>

                  <h4 className="font-bold text-[14px] text-neutral-900 dark:text-white leading-tight mb-1">
                    {d.profile.name}
                  </h4>
                  ...
                  <div className="grid grid-cols-2 gap-2 p-2.5 bg-white dark:bg-neutral-950 rounded-xl border border-neutral-200 dark:border-neutral-800 text-[11px] font-tabular mb-3">
                    <div>
                      <span className="text-[9px] text-neutral-500 uppercase block">Vendas Mês</span>
                      <strong className="text-neutral-900 dark:text-white">R$ {(d.salesRevenue / 1000).toFixed(0)}k</strong>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 uppercase block">Pátio Loja</span>
                      <strong className="text-neutral-900 dark:text-white">{d.stockCount} motocicletas</strong>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 uppercase block">Cota Pedida</span>
                      <strong className="text-neutral-700 dark:text-neutral-300">{d.quotaOrdered} de {d.quotaAllocated} un.</strong>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 uppercase block">Crédito Usado</span>
                      <strong className={d.creditUsagePercent > 80 ? 'text-amber-600 dark:text-amber-400' : 'text-neutral-700 dark:text-neutral-300'}>
                ...
                <div className="flex items-center gap-2 pt-2 border-t border-neutral-200 dark:border-neutral-800">
                  ...
                  <button
                    onClick={() => setAuditDealer(d.profile)}
                    className="px-3 py-2 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-xl text-[11px] font-bold transition-colors"
                  >
                    Auditar
                  </button>
                </div>
      ...
      {auditDealer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl max-w-2xl w-full p-6 md:p-8 shadow-2xl relative overflow-hidden max-h-[90vh] overflow-y-auto">
            <button 
              onClick={() => setAuditDealer(null)}
              className="absolute top-5 right-5 p-2 text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-xl"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-[20px] font-bold text-neutral-900 dark:text-white">{auditDealer.name}</h3>
                <p className="text-[12px] text-neutral-500 dark:text-neutral-400">{auditDealer.city} ({auditDealer.state}) • CNPJ: {auditDealer.cnpj}</p>
              </div>
            </div>
            ...
            <div className="space-y-4 text-[13px]">
              {/* Profile Card */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 bg-neutral-50 dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 font-tabular">
                <div>
                  <span className="text-[10px] text-neutral-500 dark:text-neutral-400 uppercase block">Gerente Titular</span>
                  <strong className="text-neutral-900 dark:text-white">{auditDealer.manager}</strong>
                </div>
                <div>
                  <span className="text-[10px] text-neutral-500 dark:text-neutral-400 uppercase block">Contato Telefônico</span>
                  <strong className="text-neutral-900 dark:text-white">{auditDealer.phone}</strong>
                </div>
                <div>
                  <span className="text-[10px] text-neutral-500 dark:text-neutral-400 uppercase block">Meta Mensal</span>
                  <strong className="text-emerald-600 dark:text-emerald-400">R$ {auditDealer.monthlyTarget.toLocaleString('pt-BR')}</strong>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Credit Limit */}
                <div className="p-4 bg-neutral-50 dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold text-neutral-700 dark:text-neutral-300">Limite de Crédito de Fábrica</span>
                    <CreditCard className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                  </div>
                  <p className="text-[18px] font-bold text-neutral-900 dark:text-white font-tabular">
                  ...
                  <button
                    ...
                    className="w-full bg-neutral-200 dark:bg-neutral-800 hover:bg-neutral-300 dark:hover:bg-neutral-700 text-neutral-900 dark:text-white font-bold py-2 rounded-xl text-[11px] transition-colors"
                  >
                ...
                <div className="p-4 bg-neutral-50 dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold text-neutral-700 dark:text-neutral-300">Cota Mensal de Motocicletas</span>
                  ...
                  <button
                    ...
                    className="w-full bg-blue-100 dark:bg-blue-600/30 hover:bg-blue-200 dark:hover:bg-blue-600 text-blue-800 dark:text-blue-300 hover:text-white font-bold py-2 rounded-xl text-[11px] transition-colors"
                  >
                    Liberar Cota Extra
                  </button>
                </div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-neutral-200 dark:border-neutral-800">
                ...
                <button
                  onClick={() => setAuditDealer(null)}
                  className="px-5 py-3 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-2xl text-[12px] font-bold transition-colors"
                >
                  Fechar
                </button>
              </div>
      ...
      {creditAdjustmentDealer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl max-w-md w-full p-6 shadow-2xl relative">
            <button 
              onClick={() => setCreditAdjustmentDealer(null)}
              className="absolute top-4 right-4 p-1.5 text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-xl"
            >
              <X className="w-4 h-4" />
            </button>
            <div className="flex items-center gap-2.5 mb-3">
              <CreditCard className="w-5 h-5 text-blue-600 dark:text-blue-400" />
              <h3 className="text-[16px] font-bold text-neutral-900 dark:text-white">Ajuste de Crédito J. Toledo</h3>
            </div>
            <p className="text-[12px] text-neutral-500 dark:text-neutral-400 mb-4">
              Concessionária: <strong className="text-neutral-900 dark:text-white">{creditAdjustmentDealer.name}</strong>
            </p>
            <div className="space-y-3">
              <div>
                <label className="text-[11px] font-bold text-neutral-500 dark:text-neutral-400 uppercase block mb-1">Novo Limite (R$)</label>
                <input
                  type="number"
                  defaultValue={creditAdjustmentDealer.creditLimit || 3000000}
                  className="w-full bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded-xl px-3 py-2 text-neutral-900 dark:text-white font-tabular text-[13px] focus:outline-none focus:border-blue-500"
                />
              </div>
              <div className="flex gap-2 pt-2">
                ...
                <button
                  onClick={() => setCreditAdjustmentDealer(null)}
                  className="px-4 py-2.5 bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 font-bold rounded-xl text-[12px]"
                >
                  Cancelar
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl max-w-md w-full p-6 shadow-2xl relative">
            ...
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <h3 className="text-[16px] font-bold text-neutral-900 dark:text-white">Liberação de Cota Extra</h3>
            </div>
            <p className="text-[12px] text-neutral-500 dark:text-neutral-400 mb-4">
              Concessionária: <strong className="text-neutral-900 dark:text-white">{quotaDealer.name}</strong>
            </p>
            <div className="space-y-3">
              <div>
                <label className="text-[11px] font-bold text-neutral-500 dark:text-neutral-400 uppercase block mb-1">Unidades Adicionais 0km</label>
                <input
                  type="number"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-[#27272a] rounded-3xl max-w-md w-full p-6 shadow-2xl relative">
            ...
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <h3 className="text-[16px] font-bold text-neutral-900 dark:text-white">Detalhes de Transporte de Fábrica</h3>
            </div>
            <div className="space-y-3 text-[12px]">
              <div className="p-3 bg-neutral-50 dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 space-y-1 font-tabular">
                <p className="font-bold text-neutral-900 dark:text-white text-[13px]">{selectedBatchModal.batchName}</p>
                <p className="text-neutral-500 dark:text-neutral-400">Previsão: {selectedBatchModal.eta}</p>
                <p className="text-neutral-500 dark:text-neutral-400">Localização Atual: {selectedBatchModal.location}</p>
                <p className="text-indigo-600 dark:text-indigo-300 font-bold">{selectedBatchModal.unitsCount} unidades • R$ {(selectedBatchModal.value || 0).toLocaleString('pt-BR')}</p>
              </div>
              <button
                onClick={() => setSelectedBatchModal(null)}
                className="w-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-900 dark:text-white font-bold py-2.5 rounded-xl text-[12px] transition-colors"
              >
                Fechar
              </button>
            </div>
