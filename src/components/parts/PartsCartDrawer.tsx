          ...
          <div className="p-5 border-b border-[#27272a] bg-gradient-to-r from-neutral-900 via-[#18181b] to-neutral-900 flex items-center justify-between gap-3 shrink-0">
            ...
            <div className="flex items-center gap-2">
              {items.length > 0 && (
                <button
                  onClick={onClearCart}
                  className="text-neutral-400 hover:text-red-400 text-xs p-1.5 rounded-lg hover:bg-neutral-800 transition-colors flex items-center gap-1"
              ...
              <>
                ...
                <div className="space-y-2.5">
                  ...
                  {items.map((item) => (
                    <div
                      key={item.id}
                      className="p-3.5 bg-neutral-900/80 border border-neutral-800 rounded-2xl flex items-start justify-between gap-3 hover:border-neutral-700 transition-colors"
                    >
                      <div className="flex-1 min-w-0 space-y-1">
                        ...
                        <div className="text-[11px] text-neutral-400">
                          Modelo: <span className="text-neutral-300 font-bold">{item.modelName}</span>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 pt-2 border-t border-neutral-800">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                      ...
                      >
                        ...
                        <span className="text-[10px] text-neutral-400">Giro Programado</span>
                      </button>
                      ...
                      >
                        ...
                        <span className="text-[10px] text-neutral-400">Moto Parada (24h)</span>
                      </button>
                      ...
                      >
                        ...
                        <span className="text-[10px] text-neutral-400">Pós-Venda Oficial</span>
                      </button>
                    </div>
                  </div>
                  ...
                  {(orderType === 'urgente_vor' || orderType === 'garantia_pos_venda') && (
                    <div className="space-y-1.5 bg-neutral-900/90 border border-neutral-800 p-3 rounded-xl">
                      ...
                      <input
                        ...
                        className="w-full bg-neutral-950 border border-neutral-700 rounded-lg px-3 py-1.5 text-xs text-white uppercase font-mono placeholder-neutral-500 focus:outline-none focus:border-amber-400"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-blue-500"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-neutral-900 border border-neutral-800 rounded-xl p-3 text-xs text-white placeholder-neutral-500 focus:outline-none focus:border-blue-500 resize-none"
                    />
                  </div>

                  {/* Financial Summary Box */}
                  <div className="bg-neutral-950 border border-neutral-800 rounded-2xl p-4 space-y-2 font-tabular">
