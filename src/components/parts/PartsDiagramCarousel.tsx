      ...
      <div className="flex items-center justify-between mb-2.5 px-1">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="w-7 h-7 rounded-lg bg-white dark:bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 text-neutral-700 dark:text-neutral-300 hover:text-white flex items-center justify-center transition-colors"
            title="Anterior"
          >
            ...
            <div
              ...
              className={`
                ...
                ${isSelected
                  ...
                  : 'border-neutral-200 dark:border-neutral-800 hover:border-neutral-600 hover:bg-white dark:bg-neutral-900/80'
                }
              `}
            >
              {/* Real Technical Drawing Thumbnail */}
              <div className="aspect-[4/3] rounded-lg bg-[#0d0d10] border border-neutral-200 dark:border-neutral-800 overflow-hidden flex items-center justify-center relative mb-2 group-hover:border-neutral-700">
                <img
                ...
                <span className={`
                  ...
                  ${isSelected ? 'bg-amber-400 text-black' : 'bg-black/70 text-neutral-700 dark:text-neutral-300 border border-neutral-700'}
                `}>
