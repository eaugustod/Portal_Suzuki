        ...
        {diagrams.map((diagram) => {
          ...
          return (
            ...
            >
              ...
              <div className="aspect-[4/3] rounded-lg bg-[#0d0d10] border border-neutral-800 overflow-hidden flex items-center justify-center relative mb-2 group-hover:border-neutral-700">
                <img
                ...
                <span className={`
                  ...
                  ${isSelected ? 'bg-amber-400 text-black' : 'bg-black/70 text-neutral-300 border border-neutral-700'}
                `}>
